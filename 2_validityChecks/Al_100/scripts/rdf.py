...
# FCC Al lattice constant (in Ångstroms)
a = 4.05  # Å

# Compute theoretical NN and 2NN distances for FCC
d_1NN = a / (2**0.5) # 1NN: along face diagonal
d_2NN = a  # 2NN: along cube edge
...
plt.axvline(d_1NN, color='red', linestyle='--', label=f'1NN (FCC) = {d_1NN:.2f} Å')
plt.axvline(d_2NN, color='green', linestyle='--', label=f'2NN (FCC) = {d_2NN:.2f} Å')
